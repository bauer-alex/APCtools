...
gg1 <- plot_densityMatrix(dat                 = travel,
...
gg1
ggsave("1_descriptiveMatrix.png", width = 7, height = 6.5)

# heatmap
gg2 <- plot_APCheatmap(dat            = travel,
                       y_var          = "mainTrip_distance",
                       y_var_logScale = TRUE,
...
ggsave("1_descriptive.png", width = 14, height = 6.5)

# hexamap
png("1_descriptiveHexamap.png", width = 1200, height = 1000, pointsize = 30)
...
# exemplary partial effect plot
plot_partialAPCeffects(model_pure, travel, "period")

create_APCsummary(list(model_pure), travel)

# hexamap
png("2_modelHexamap.png", width = 1200, height = 1000, pointsize = 30)
plot_APChexamap(dat   = travel,
                model = model_pure)
dev.off()
